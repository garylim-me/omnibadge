"""
Django settings for omnibadge project.
...
SECRET_KEY = 'dmy7&$kf92p_$8(&qof!9c=t3*1=((r-@cjmlj&xm%lq65j)_k'
...
WSGI_APPLICATION = 'omnibadge.wsgi.application'
